(function( $, undefined ) {
    ...
    var defaults = {
        ...
        previousText: 'Previous1',   // Text to display on previous skip button
    ...
    Slides.prototype._init = function() {
        ...
        // Create skip links
        if ( this.opts.skip ) {
		  console.log('74 Create skip links');
    ...
    Slides.prototype.next = function() {
		console.log('188 Slides.prototype.next');
    ...
    Slides.prototype.previous = function() {
		console.log('196 Slides.prototype.previous');
        this.to(this.current - 1);
    };
    ...
    console.log("208 Slides.prototype.to x="+x+"  user:"+user+' this.current:'+this.current+'   this.opts.jumpQueue:'+ this.opts.jumpQueue );
    ...
    Slides.prototype.transitions = {
        ...
        //*******************
        crossfade: function() {
            console.log('--transitions--> function crossfade');
            var self = this;
            ...
            this.execute = function() {
                console.log('--transitions--> function crossfade function execute');
        ...
        //*****************
        scroll: function() {
            console.log('--transitions--> function scroll');
            var self = this;
            var carouselWidth = 0;
            ...
            this.execute = function() {
                console.log('--transitios->function scroll function execute ');
            ...
            this.teardown = function() {
                console.log('--transactions-->function teardown');
                this.scrollable = true;
    ...
    $.fn.slides = function( options ) {
		console.log('395  jQuery plugin wrapper  options:'+options);
        return this.each(function() {
            if ( ! $.data(this, 'slides') ) {
				console.log('398  >>>>>>>  jQuery plugin wrapper  options:'+options);
